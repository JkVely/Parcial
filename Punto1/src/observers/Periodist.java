...
public class Periodist implements Observer {
    private String name;
    private String email;
    
    public Periodist(String name, String email) {
        this.name = name;
        this.email = email;
    }
    ...
    public void update(List<Course> courses) {
        System.out.println("Periodist " + name + " has been notified of courses updates:");
